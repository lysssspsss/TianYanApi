...
class Message extends Base
{
     ...
     */
    public static function getAcsClient($accessKeyId = ALIYUN_ACCESS_KEY_ID,$accessKeySecret = ALIYUN_ACCESS_KEY_SECRET) {
     ...
     * @return stdClass
     */
    public static function querySendDetails($phone,$date,$bizid,$pagesize = 1,$page = 1) {
