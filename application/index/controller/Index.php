...
本《协议》可由本公司随时更新，更新后的协议条款一旦公布即代替原来的协议条款，恕不再另行通知，用户可在本公司官微上查阅最新版协议条款。在修改《协议》条款后，如果用户不接受修改后的条款，请立即停止使用本公司提供的网络服务，继续使用的用户将被视为已接受了修改后的协议。
...
4.用户理解，天雁商学院仅提供相关的网络服务，除此之外与相关网络服务有关的设备（如手机或其他与接入互联网或移动网有关的装置）及所需的费用（如为接入互联网而支付的上网费、为使用移动网而支付的手机费）均应由用户自行负担。
...
3.用户有义务保证自身账号的安全，用户利用该账号所进行的一切活动引起的任何损失或损害，由用户自行承担全部责任，本公司不承担任何责任。如用户发现账号遭到未授权的使用或发生其他任何安全问题，应立即修改账号密码并妥善保管。因黑客行为或用户的保管疏忽导致账号非法使用，本公司不承担任何责任。
...
五、声明
任何单位或个人未经天雁商学院授权许可，不得以天雁商学院提供的产品和服务内容，及天雁商学院商标、文字、形象、标识等进行营利活动，天雁商学院将保留对前述行为人追究法律责任的权利。</pre>';
        $result['code'] = OK;
        $result['data'] = $content;
