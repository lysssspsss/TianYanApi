...
class Ajaxbootstrap extends Paginator
{
    ...
    protected function getAvailablePageWrapper($url, $page)
    {
        ...
        $status = explode('=',$match[0][0]);
        $isthumb = explode('=',$match[0][1]);
        $input = explode('=',$match[0][2]);
        return '<li><a href="javascript:ajaxload('.$status[1].','.$page.',\''.$input[1].'\','.$isthumb[1].');">' . $page . '</a></li>';
    }
