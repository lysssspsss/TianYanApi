...
class Category extends Common
{
    ...
    public function index()
    {
        if($this->categorys){
            foreach($this->categorys as $r) {
                if($r['module']=='page'){
                    $r['str_manage'] = '<a class="orange" href="'.url('admin/page/edit',array('id'=>$r['id'])).'" title="修改内容"><i class="ace-icon fa fa-pencil-square-o bigger-130"></i></a> | ';
                }else{
                    $r['str_manage'] = '';
                }
                $r['str_manage'] .= '<a class="green" title="添加子栏目" href="'.url('Category/add',array( 'parentid' => $r['id'])).'"> <i class="ace-icon fa fa-plus-square bigger-130"></i></a> | <a href="'.url('Category/edit',array( 'id' => $r['id'])).'" title="修改"><i class="ace-icon fa fa-pencil bigger-130"></i></a> | <a class="red" href="javascript:del(\''.$r['id'].'\')" title="删除"><i class="ace-icon fa fa-trash-o bigger-130"></i></a> ';
            ...
            $str  = "<tr><td><input name='listorders[\$id]' type='text' size='10' value='\$listorder' class='list_order'></td><td class='visible-lg visible-md'>\$id</td>";

            $str.="<td class='text-left'>\$spacer<a href='".__ROOT__."/index.php/admin/\$module/\$action/\$files/\$id'>\$catname </a>&nbsp;</td>";

            $str.="<td class='visible-lg visible-md'>\$modulename</td><td class='visible-lg visible-md'>\$dis</td><td>\$str_manage</td></tr>";
            $tree = new Tree ($array);
            $tree->icon = array('&nbsp;&nbsp;&nbsp;│  ','&nbsp;&nbsp;&nbsp;├─ ','&nbsp;&nbsp;&nbsp;└─ ');
            $tree->nbsp = '&nbsp;&nbsp;&nbsp;';
    ...
    public function repair() {
        ...
        if(is_array($this->categorys)) {
            foreach($this->categorys as $id => $cat) {
                ...
                $this->dao->update(array('parentdir'=>$parentdir,'arrparentid'=>$arrparentid,'arrchildid'=>$arrchildid,'child'=>$child,'id'=>$id));
            }
        }
    }
    ...
    public function ruleorder(){
        ...
        foreach($ids as $key=>$r) {
            $data['listorder']=$r;
            $this->dao->where('id='.$key)->update($data);
        }
        $result = ['info' => '排序成功！', 'status' => '1','url'=>url('index')];
        savecache('Category');
        return $result;
    }
}